...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dolang-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9583&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dolang-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dolang` can be installed with:

```
conda install dolang
```

It is possible to list all of the versions of `dolang` available on your platform with:
